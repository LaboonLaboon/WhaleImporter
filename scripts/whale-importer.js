// Ensure Foundry is fully loaded before we register our UI hooks
Hooks.once('ready', () => {
  console.log("🐋 Whale Importer | Ready – registering Actor Directory hook");

  // This fires whenever the Actors sidebar is rendered
  Hooks.on('renderActorDirectory', (actorDirectory, html) => {
    ...
    // Add our import button into the directory-footer
  ...
  switch (type) {
    ...
    case 'weapon': {
      ...
      sys.weapon = {
        ...
        dvTable:    raw.dvTable?.startsWith('DV ') ? raw.dvTable : `DV ${raw.dvTable}`,
        ...
        quality:    (raw.quality || raw.rarity || 'standard').toLowerCase(),
